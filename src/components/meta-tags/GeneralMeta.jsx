export default function GeneralMeta() {
  return (
    <head>
      ...
      <meta name="subject" content="Joshua Edo • Software Developer" />
      <meta name="url" content="https://www.joshuaedo.com" />
      <meta name="identifier-URL" content="https://www.joshuaedo.com" />
      <meta name="pagename" content="Joshua Edo" />
      <meta name="title" content="Joshua Edo • Software Developer" />
      <meta
        name="keywords"
        content="Joshua Edo, Web developer, Josh, Frontend Developer, Software Developer, Who is Joshua Edo, =)"
      />
      <meta
        name="robots"
      ...
      <meta itemProp="name" content="Joshua Edo's Portfolio" />

      {/* OpenGraph */}
      <meta property="og:title" content="Joshua Edo • Software Developer" />
      <meta property="og:description" content="Home on Joshua Edo's Website" />
      <meta property="og:url" content="https://joshuaedo.com" />
      ...
      {/* Twitter */}
      <meta name="twitter:title" content="Joshua Edo • Software Developer" />
